...
public class BatchExistConditionImpl extends ASTWrapperPsiElement implements BatchExistCondition {

  public BatchExistConditionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatchVisitor visitor) {
    visitor.visitExistCondition(this);
  }
