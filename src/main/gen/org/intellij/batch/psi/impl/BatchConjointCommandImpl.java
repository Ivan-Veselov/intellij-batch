...
public class BatchConjointCommandImpl extends BatchCommandImpl implements BatchConjointCommand {

  public BatchConjointCommandImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BatchVisitor visitor) {
    visitor.visitConjointCommand(this);
  }
